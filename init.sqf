...
/* Test only */
	...
	_action_acces_1 = [
		...
		{(computerToHack_test getVariable "challengeSuccessfull")}
	] call ace_interact_menu_fnc_createAction;
	[computerToHack_test, 0, ["ACE_MainActions"], _action_acces_1] call ace_interact_menu_fnc_addActionToObject;
	*/
/* End of test only */
